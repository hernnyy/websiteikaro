...
CREATE TABLE IF NOT EXISTS `u693453499_turno`.`emt_address` (
  `id_emt_address` SMALLINT(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `u693453499_turno`.`emt_meetplaces` (
  `id_emt_meetplaces` SMALLINT(10) NOT NULL AUTO_INCREMENT,
  ...
  `modify_user` VARCHAR(45) NULL,
  `active` TINYINT(1) NOT NULL DEFAULT 1,
  `fk_id_emt_address` SMALLINT(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `u693453499_turno`.`emt_contacts` (
  `id_emt_contacts` SMALLINT(10) NOT NULL AUTO_INCREMENT,
  ...
  `modify_user` VARCHAR(45) NULL,
  `active` TINYINT(1) NOT NULL DEFAULT 1,
  `fk_id_emt_meetplaces` SMALLINT(10) NULL,
...
CREATE TABLE IF NOT EXISTS `u693453499_turno`.`emt_customers` (
  `id_emt_customers` SMALLINT(10) NOT NULL AUTO_INCREMENT,
  `dots` INT NOT NULL,
  `status` VARCHAR(7) NOT NULL DEFAULT 'OK',
  `comments` VARCHAR(255) NULL,
  `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `u693453499_turno`.`emt_providers` (
  `id_emt_providers` SMALLINT(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `u693453499_turno`.`emt_users` (
  `id_emt_users` SMALLINT(10) NOT NULL AUTO_INCREMENT,
  ...
  `modify_user` VARCHAR(45) NULL,
  `active` TINYINT(1) NOT NULL DEFAULT 1,
  `fk_id_emt_customers` SMALLINT(10) NULL,
  `fk_id_emt_providers` SMALLINT(10) NULL,
  PRIMARY KEY (`id_emt_users`, `fk_id_emt_customers`, `fk_id_emt_providers`),
...
CREATE TABLE IF NOT EXISTS `u693453499_turno`.`emt_persons` (
  `id_emt_persons` SMALLINT(10) NOT NULL AUTO_INCREMENT,
  ...
  `active` TINYINT(1) NOT NULL DEFAULT 1,
  `fk_id_emt_address` SMALLINT(10) NOT NULL,
  `fk_id_emt_contacts` SMALLINT(10) NOT NULL,
  `fk_id_emt_users` SMALLINT(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `u693453499_turno`.`emt_meets` (
  `id_emt_meets` SMALLINT(10) NOT NULL AUTO_INCREMENT,
  `date` TIMESTAMP NULL,
  `status` VARCHAR(7) NOT NULL DEFAULT 'OK',
  `comments` VARCHAR(255) NULL,
  `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `modify_user` VARCHAR(45) NULL,
  `active` TINYINT(1) NOT NULL DEFAULT 1,
  `fk_id_emt_customers` SMALLINT(10) NOT NULL,
  `fk_id_emt_providers` SMALLINT(10) NOT NULL,
  `fk_id_emt_meetplaces` SMALLINT(10) NOT NULL,
